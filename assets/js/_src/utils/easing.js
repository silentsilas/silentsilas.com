 ...
 */
    ...
    // decelerating to zero velocity 
    const easeOutQuart = function (t) { return 1-(--t)*t*t*t };
    // acceleration until halfway, then deceleration
    const easeInOutQuart = function (t) { return t<.5 ? 8*t*t*t*t : 1-8*(--t)*t*t*t };
    // accelerating from zero velocity
    const easeInQuint = function (t) { return t*t*t*t*t };
    // decelerating to zero velocity
  ...
  export { easeInQuad, easeOutQuad, easeInOutQuad, easeInCubic, easeOutCubic, easeInOutCubic, easeInQuart, easeOutQuart, easeInOutQuart };